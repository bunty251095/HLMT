...
@Database(entities = [Users::class ,AppVersion::class , HRAQuestions::class ,HRAVitalDetails::class  , HRALabDetails::class, HRASummary::class,
    ...
    TrackParameterMaster.History::class,TrackParameters::class,AppCacheMaster::class], version = 3, exportSchema = true)
