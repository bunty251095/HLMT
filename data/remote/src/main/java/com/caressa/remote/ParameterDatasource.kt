...
class ParameterDatasource(private val defaultService: ApiService, private val encryptedService: ApiService){
    ...
    fun getParameterPreferences(data: ParameterPreferenceModel) = encryptedService.getParameterPreferences(data)
    ...
    fun getBloodPressureHistory(data: BloodPressureHistoryModel) = encryptedService.getBloodPressureHistory(data)
