    ...
    private fun setClickable() {
        ...
        binding.btnNext.setOnClickListener {
            if ( Validations.validateMultiSelectionOptions(binding.optionContainer) ) {
                ...
                Utilities.toastMessageShort(requireContext(), resources.getString(R.string.PLEASE_SELECT_OPTION))
            }
        }
    ...
    private fun nextButtonClick() {
        ...
        when(qCode)  {
            ...
            "KNWDIANUM" -> {
                ...
                if ( selectedOptions.isEmpty() || selectedOptions.any { it.answerCode.contains("DONT", ignoreCase = true)
                            || it.answerCode.contains("NONE", ignoreCase = true) }) {
                    viewModel.saveResponse(qCode, "85_NO","No", questionData.category, questionData.tabName, "")
            ...
            "KNWLIPNUM" -> {
                ...
                if ( selectedOptions.isEmpty() || selectedOptions.any { it.answerCode.contains("DONT", ignoreCase = true)
                            || it.answerCode.contains("NONE", ignoreCase = true) }) {
                    viewModel.saveResponse(qCode, "84_NO","No", questionData.category, questionData.tabName, "")
    ...
    private fun previousRadioBtnOptionClick() {
        ...
        when(qCode)  {
            ...
            "KNWLIPNUM" -> {
                ...
                if (prevAnsList.any { it.answerCode.contains("DONT", ignoreCase = true)
                            || it.answerCode.contains("NONE", ignoreCase = true) }) {
                    viewModel.saveResponse(qCode, "84_NO","No", questionData.category, questionData.tabName, "")
                    viewPagerActivity!!.setCurrentScreen(viewPagerActivity!!.getCurrentScreen() - 2)
                } else {
...
/*            } else {
    ...
    private var checkChangeListener = CompoundButton.OnCheckedChangeListener { view, isChecked ->
        ...
        if ( isChecked && !view.text.toString().equals(resources.getString(R.string.NONE), ignoreCase = true) ) {
