    ...
    fun listHistoryWithLatestRecord( fitnessData : FitnessData ) = viewModelScope.launch {
        withContext(dispatchers.io){
            try {
                ...
                var systolic = -1
                var diastolic = -1
                var color = R.color.vivant_icon_warm_grey
                ...
                if ( !paramWeight.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_weight,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.weight), " -- ", "WEIGHT"))
                }
                ...
                if ( !paramWaist.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_waist,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.waist), " -- ", "WAIST"))
                }
                ...
                if ( !paramBMI.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_profile_bmi,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.bmi), " -- ", "BMI"))
                }
                ...
                if ( !paramWhr.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_profile_whr,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.whr), " -- ", "WHR"))
                }
                ...
                if (systolic != -1 && diastolic != -1) {
                    ...
                    if ( !Utilities.isNullOrEmpty( paramBp[systolic].value.toString())
                        ...
                        list.add(DashboardParamGridModel(R.drawable.img_profile_bp,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.bp), " -- ", "BP"))
                    }
                } else {
                    list.add(DashboardParamGridModel(R.drawable.img_profile_bp,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.bp), " -- ", "BP"))
                }
                ...
                if ( !paramPulse.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_heart_risk,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.pulse), " -- ", "PULSE"))
                }
                ...
                if ( !paramSugar.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_profile_blood_sugar,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.bs), " -- ", "SUGAR"))
                }
                ...
                if ( !paramChol.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_cholesteroal,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.cholesterol), " -- ", "CHOL"))
                }
                ...
                if ( !paramHb.isNullOrEmpty() ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_hemoglobin,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.hemoglobin), " -- ", "HEMOGLOBIN"))
                }
                ...
                if ( !Utilities.isNullOrEmptyOrZero(steps) ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_step,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.steps), "0", "STEPS"))
                }
                ...
                if ( !Utilities.isNullOrEmptyOrZero(calories) ) {
                    ...
                    list.add(DashboardParamGridModel(R.drawable.img_calories,R.color.vivant_icon_warm_grey,context.resources.getString(R.string.calories), "0", "CAL"))
                }
