    ...
    fun initialise() {
        ...
        binding.layoutDashboard.setOnTouchListener { v: View, event: MotionEvent ->
            ...
            if (event.action == MotionEvent.ACTION_UP || event.action == MotionEvent.ACTION_CANCEL) {
                ...
                ImageViewCompat.setImageTintList(binding.imgDashboard, ColorStateList.valueOf(ContextCompat.getColor(requireContext(),R.color.colorPrimary)))
        ...
        binding.layoutAddMedicine.setOnTouchListener { v: View, event: MotionEvent ->
            ...
            if (event.action == MotionEvent.ACTION_UP || event.action == MotionEvent.ACTION_CANCEL) {
                v.setBackgroundColor(ContextCompat.getColor(requireContext(),R.color.white))
                ImageViewCompat.setImageTintList(binding.imgAddMedicine, ColorStateList.valueOf(ContextCompat.getColor(requireContext(),R.color.colorPrimary)))
        ...
        binding.layoutMyMedications.setOnTouchListener { v: View, event: MotionEvent ->
            ...
            if (event.action == MotionEvent.ACTION_UP || event.action == MotionEvent.ACTION_CANCEL) {
                v.setBackgroundColor(ContextCompat.getColor(requireContext(),R.color.white))
                ImageViewCompat.setImageTintList(binding.imgDueMedicine, ColorStateList.valueOf(ContextCompat.getColor(requireContext(),R.color.colorPrimary)))
