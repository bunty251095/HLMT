...
object FirebaseConstants{
    ...
    const val HLMT_LOGIN_SUCCESSFUL_EVENT = "login_successful"
    const val HLMT_LOGIN_FAIL_EVENT = "login_fail"
    const val SEND_OTP_SUCCESSFUL_EVENT = "send_otp_successful"
    const val SEND_OTP_FAIL_EVENT = "send_otp_fail"
    const val SEND_OTP_VERIFICATION_SUCCESSFUL_EVENT = "send_otp_verification_successful"
    const val SEND_OTP_VERIFICATION_FAIL_EVENT = "send_otp_verification_fail"
    const val RESEND_OTP_EVENT = "resend_otp"
    const val NON_HLMT_LOGIN_SUCCESSFUL_EVENT = "non_hlmt_login_successful"
    const val NON_HLMT_LOGIN_FAIL_EVENT = "non_hlmt_login_fail"
    const val NON_HLMT_REGISTRATION_SUCCESSFUL_EVENT = "non_hlmt_registration_successful"
    const val NON_HLMT_REGISTRATION_FAIL_EVENT = "non_hlmt_registration_fail"

    // Screen View
    const val LOGIN_SCREEN = "login"
    const val FORGET_PASSWORD_SCREEN = "forget_password"
    const val CHANGE_PASSWORD_SCREEN = "change_password"
    const val OTP_VERIFY_SCREEN = "otp_verification"
    const val TERMS_CONDITIONS_SCREEN = "terms_conditions"
    const val DISCLAIMER_SCREEN = "disclaimer"
    const val ACTIVITY_TRACKER_SCREEN = "activity_tracker"
    const val ACTIVITY_TRACKER_MONTHLY_DETAIL_SCREEN = "activity_tracker_monthly_detail"
    const val MEDICINE_TRACKER_SCREEN = "medicine_tracker"
    const val HEALTH_PARAMETERS_TRACKER_SCREEN = "health_parameters_tracker"
    const val HEALTH_RECORDS_SCREEN = "health_records"
    const val TOOLS_CALCULATORS_SCREEN = "tools_calculators"
    const val HEART_AGE_CALCULATOR_SCREEN = "heart_age_calculator"
    const val DIABETES_CALCULATOR_SCREEN = "diabetes_calculator"
    const val HYPERTENSION_CALCULATOR_SCREEN = "hypertension_calculator"
    const val STRESS_CALCULATOR_SCREEN = "stress_anxiety_calculator"
    const val SMART_PHONE_CALCULATOR_SCREEN = "smart_phone_addiction_calculator"
    const val DUE_DATE_CALCULATOR_SCREEN = "due_date_calculator"
    const val BLOGS_SCREEN = "blogs"
    const val MAX_BENIFITS_SCREEN = "max_benifits_pdf"
    const val ABOUT_US_SCREEN = "about_us"
    const val CONTACT_US_SCREEN = "contact_us"
    const val FAQ_SCREEN = "faq"

    const val HLMT_LOGIN_SCREEN_EVENT = "hlmt_login"
