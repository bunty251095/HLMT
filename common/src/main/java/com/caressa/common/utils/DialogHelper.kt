...
//    }
    ...
    fun showDatePickerDialog(title:String="",context: Context,date:Calendar?, minDate:Calendar?, maxDate:Calendar?,listener: DateListener){
        ...
        val dpd = DatePickerDialog(context,
            DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                ...
                listener.onDateSet(strDate!!,year = year.toString(),month=_monthOf,dayOfMonth = _monthOfDay)
