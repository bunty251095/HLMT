...
import com.caressa.common.utils.filepicker.adapters.SectionsPagerAdapter
import com.caressa.common.utils.filepicker.models.Document
import com.caressa.common.utils.filepicker.models.FileType
import com.caressa.common.utils.filepicker.utils.TabLayoutHelper
import com.caressa.common.utils.filepicker.viewmodels.VMDocPicker
...
class DocPickerFragment : BaseFragment() {
    ...
    private fun initView() {
        setUpViewPager()
        viewModel.lvDocData.observe(viewLifecycleOwner, { files ->
